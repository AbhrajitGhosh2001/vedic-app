...
export async function updateSession(request: NextRequest) {
  ...
  try {
    ...
    // Session error - continue without user to avoid blocking
  }

  // Protected routes that require authentication
  const protectedRoutes = ['/protected', '/onboarding', '/dashboard', '/matches', '/compatibility', '/messages', '/profile/insights']
